...
export default function CalculatorPage() {
  ...
  const [result, setResult] = useState<Result | null>(savedData?.result ?? null);
  ...
  }, [data, inputValues, result]);

  const numericKeys: (keyof UserInput)[] = ['weight', 'height', 'age', 'waist', 'neck', 'hip'];

  const decimalKeys: (keyof UserInput)[] = ['weight', 'height', 'waist', 'neck', 'hip'];
          ...
          <div className="form">
            ...
            <div className="form-grid">
              <div className="field-group">
                ...
                {errors.waist && <small>{errors.waist}</small>}
              </div>
              ...
              <div className="field-group">
                ...
                {errors.neck && <small>{errors.neck}</small>}
              </div>
              ...
              {data.gender === 'female' && (
                <div className="field-group">
                  ...
                  {errors.hip && <small>{errors.hip}</small>}
                </div>
              )}
            </div>
