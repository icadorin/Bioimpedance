...
import type { SkinfoldInput, SkinfoldInputValues } from '../types/skinfold.types';
import type { InputValues } from '../types/input.types';

export const initialNavyData: UserInput = {
  weight: 0,
  height: 0,
  age: 0,
  gender: 'male',
...
export const initialNavyInputValues: InputValues = {
  weight: '',
  height: '',
  age: '',
  waist: '',
