...
export const EMPTY_MESSAGES: Partial<Record<keyof NavyAssessmentInput, string>> = {
...
export const INVALID_MESSAGES: Partial<Record<keyof NavyAssessmentInput, string>> = {
